...
Nota: la denominacion exacta del modelo o su codigo puede variar; verificar en el Fase 1 el modelo TA vigente antes de usarlo. Marcar `[verificar]` cualquier codigo no confirmado.

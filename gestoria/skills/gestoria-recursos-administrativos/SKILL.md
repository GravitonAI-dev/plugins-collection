...
2. **Petición de datos en bloque:** para cualquier grupo de datos objetivos o identificativos (datos del interesado y del representante, datos del acto y del expediente, datos del daño y su valoración), **NO preguntes dato por dato en el chat**. Invoca `slot_filling_request` agrupando todos los campos del bloque de una sola vez.

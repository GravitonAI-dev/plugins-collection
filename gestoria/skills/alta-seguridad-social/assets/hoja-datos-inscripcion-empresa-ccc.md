...
- [ ] Documento de constitucion o identificacion del empleador (escritura y CIF, o NIF si es persona fisica).
- [ ] Certificado digital para la sede electronica de la TGSS o autorizacion del Sistema RED.
- [ ] Documento de asociacion con la mutua de accidentes de trabajo elegida.
- [ ] Actividad economica (CNAE) para determinar el epigrafe de cotizacion por accidentes.
- [ ] Inscripcion tramitada ANTES del alta del primer trabajador.
- [ ] En baja del CCC: baja previa de todos los trabajadores en ese codigo.

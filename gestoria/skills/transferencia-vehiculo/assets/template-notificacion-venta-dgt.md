...
**Interesado (vendedor / transmitente)**
...
- [ ] Notificacion de venta (impreso oficial o tramite en Sede Electronica)
- [ ] Contrato de compraventa firmado por ambas partes (o factura)
- [ ] DNI/NIE/CIF del vendedor
- [ ] Justificante de pago de la tasa de notificacion de venta

## 5. Organismo, tasa y plazo
...
> 2. La notificacion de venta permite al vendedor dejar de figurar como titular, pero no sustituye al cambio de titularidad, que corresponde al comprador.
> 3. Conservar el justificante de la notificacion como prueba de la fecha de la transmision.

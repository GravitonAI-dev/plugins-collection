...
1. **Escritura del documento (`create_file`):**
   ...
   - Aplica **Zero-Omission**: sustituye todos los datos ya resueltos por la clasificación y la escucha activa; deja como marcador con su nombre propio de plantilla (`{{razon_social_empresa}}`, `{{fecha_efectos}}`) los que resten.

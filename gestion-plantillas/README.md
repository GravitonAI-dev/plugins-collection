...
- `io.gravitonai.tools.list_skills_and_assets`: Descubrimiento dinámico de skills y assets del catálogo.
- `io.gravitonai.tools.set_skill_template`: Persistencia de la plantilla personalizada en el orquestador.
- `io.gravitonai.tools.restricted_human_in_the_loop_request`: Selección guiada de skill y asset objetivo.

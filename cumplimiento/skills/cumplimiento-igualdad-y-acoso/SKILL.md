...
2. **Petición de datos en bloque:** para cualquier grupo de datos objetivos (datos de la entidad y convenio, composición de la plantilla por sexo y grupo, datos retributivos, composición de la comisión), **NO preguntes dato por dato en el chat**. Invoca `slot_filling_request` agrupando todos los campos del bloque de una sola vez.

...
2. **Petición de datos en bloque:** para cualquier grupo de datos objetivos o identificativos (datos de la entidad, composición del órgano de administración, datos del responsable del sistema, canales y direcciones), **NO preguntes dato por dato en el chat**. Invoca `slot_filling_request` agrupando todos los campos del bloque de una sola vez.

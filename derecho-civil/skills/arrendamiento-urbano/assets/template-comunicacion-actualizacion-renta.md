...
> 2. La renta solo puede actualizarse si el contrato lo pacta expresamente (Art. 18.1 LAU); sin pacto, no procede esta comunicacion.  
> 3. Se recomienda el envio por burofax con certificacion de texto y acuse de recibo, al domicilio de notificaciones fijado en el contrato, para dejar constancia fehaciente de contenido, fecha y recepcion.  
> 4. La renta actualizada solo es exigible a partir del mes siguiente a la notificacion (Art. 18.2 LAU).

...
> **Advertencias:**  
> 1. Este documento es un DRAFT generado automaticamente. Debe ser revisado por un abogado colegiado antes de su envio.  
> 2. Preaviso minimo del Art. 10.1 LAU: 4 meses si comunica el arrendador, 2 meses si comunica el arrendatario, contados hacia atras desde la fecha de vencimiento. Verificar que la fecha de envio efectivo respeta el plazo: una comunicacion extemporanea no impide la prorroga anual.  
> 3. Se recomienda el envio por burofax con certificacion de texto y acuse de recibo, al domicilio de notificaciones fijado en el contrato.  
> 4. Esta comunicacion es para el vencimiento del plazo o de sus prorrogas (Art. 10 LAU); no sirve para resolver el contrato por incumplimiento (Art. 27 LAU) ni para la recuperacion por necesidad del arrendador (Art. 9.3 LAU).

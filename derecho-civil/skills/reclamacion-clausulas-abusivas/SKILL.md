...
6. Nunca inventar sentencias, numeros de resolucion, fechas ni doctrina. Marcar con `[verificar]` todo claim factual o jurisprudencial no confirmado en el Paso 1.
7. Marcar todos los campos a rellenar con `[DATO]` en mayusculas. Nunca inventar datos, cuantias, fechas ni numeros de contrato.
...
3. La jurisprudencia del TJUE y del Tribunal Supremo en materia de clausulas abusivas es cambiante; los criterios citados se verificaron el [fecha del Paso 1.3] y deben confirmarse antes de presentar. Los claims marcados [verificar] no han sido confirmados.

...
2. **Petición de datos en bloque:** para cualquier grupo de datos objetivos o identificativos (datos de las partes y de su representación, datos del procedimiento y de la resolución, identificación de documentos con su folio), **NO preguntes dato por dato en el chat**. Invoca `slot_filling_request` agrupando todos los campos del bloque de una sola vez.

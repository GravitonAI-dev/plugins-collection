...
{{inventario_activo: relacion numerada de bienes con su valor en numero y letra. Ej.: 1. Vivienda sita en [DIRECCION], referencia catastral [REF_CATASTRAL], valorada en [VALOR] euros ([VALOR_LETRA] euros). 2. Saldo en cuenta [ENTIDAD] num. [IBAN], por importe de [VALOR] euros. 3. Vehiculo matricula [MATRICULA], valorado en [VALOR] euros. 4. Ajuar domestico, valorado en [VALOR] euros.}}
...
{{calculo_cuotas: expresar la cuota que corresponde a cada heredero segun el titulo sucesorio y, cuando haya herederos forzosos, verificar que se cubre su legitima. Para descendientes: dos tercios de legitima (un tercio estricto a partes iguales y un tercio de mejora), Art. 808 CC. Reflejar, en su caso, la cuota usufructuaria del conyuge viudo, Art. 834 CC.}}
...
{{firmas_herederos: una linea de firma por cada compareciente con su nombre debajo}}

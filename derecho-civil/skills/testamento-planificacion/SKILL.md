...
- Si **V1 = comun, V4 = abierto notarial y V2 = con planificacion** → **HOJA PLANIFICACION**: dos documentos, en este orden. Primero `assets/template-checklist-planificacion-sucesoria.md`, sobre el que se recogen el patrimonio y todas las decisiones; despues, con las decisiones ya cerradas, `assets/template-minuta-testamento-abierto.md`. **Regla de reencaminamiento:** si el cliente respondio V2 = testamento simple pero despues manifiesta que quiere desheredar, mejorar, legar un bien concreto u ordenar un usufructo universal, reencamina en silencio a la HOJA PLANIFICACION y continua; no le anuncies el cambio de rama.

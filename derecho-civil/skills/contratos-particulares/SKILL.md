...
- `[dato objetivo]`: se solicita mediante `slot_filling_request` si agrupa datos, o pregunta directa. Vista previa y confirmación obligatoria en el chat. Validación de sentido: si la respuesta es absurda, imposible o no responde a lo preguntado, señala por qué y pide aclaración en el chat.

...
> **DRAFT — para revisión por el profesional responsable antes de su emisión. Debe adaptarse a la normativa deontológica del colegio de adscripción.**
...
Los siguientes conceptos son ajenos a los honorarios profesionales y serán de cuenta del destinatario, justificándose documentalmente:
...
> **Advertencias:**  
> 1. Este documento es un DRAFT. Debe ser revisado por el profesional responsable antes de su emisión.  
> 2. **El presupuesto no es la hoja de encargo.** Aceptado el presupuesto, hay que formalizar la hoja de encargo antes de iniciar la actuación: el presupuesto no contiene el régimen de obligaciones, terminación, documentación y protección de datos.  
> 3. Hacer constar siempre el **plazo de validez** y la **base informativa** sobre la que se ha elaborado: sin ellos, el presupuesto queda expuesto a una reclamación por sobrecoste cuando el asunto se revela más complejo.  
> 4. Verificar los tipos vigentes de impuesto sobre el valor añadido y de retención a cuenta del IRPF antes de emitirlo, y si el destinatario está obligado a practicar retención.  
> 5. Separar con claridad **honorarios** de **gastos y suplidos**: es la confusión que más reclamaciones genera.  
> 6. En retribución por horas, incluir una **estimación máxima orientativa** con compromiso de aviso antes de superarla: sin ella el cliente no puede controlar el gasto.  
> 7. No emitir presupuesto sin haber comprobado la ausencia de conflicto de intereses.

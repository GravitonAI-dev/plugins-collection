...
El ejercicio profesional exige cobertura de responsabilidad civil. Antes de aceptar un encargo conviene comprobar:

1. Vigencia de la póliza y fecha de renovación.
2. **Suma asegurada por siniestro y por anualidad**, y su suficiencia respecto de la cuantía del asunto que se acepta.
3. Cobertura de la **materia** del encargo: algunas pólizas excluyen actividades concretas.
4. Régimen de **reclamaciones posteriores a la terminación** de la póliza.
5. Franquicia aplicable.

Los datos del seguro se consignan en la hoja de encargo: es información relevante para el cliente y acredita la diligencia del despacho.

---

## Estilo de redacción

Principios aplicados en los assets: estructura de contrato con REUNIDOS, EXPONEN y ESTIPULACIONES numeradas; **objeto del encargo definido por inclusión y por exclusión en dos estipulaciones separadas**, porque es el origen de la mayoría de los conflictos; desglose económico en tabla con base, impuestos y retenciones separados; distinción explícita entre honorarios y gastos o suplidos; naturaleza de la obligación como estipulación propia; bloque final de advertencias dirigido al profesional que revisa, con las comprobaciones previas a la firma.

En los documentos dirigidos al cliente del despacho prima la **claridad comprensible** sobre la elegancia jurídica: una hoja de encargo que el cliente no entiende no cumple su función informativa y, si el cliente es consumidor, puede resultar inoponible.

...
### PRIMERA — Objeto y descripción del tratamiento
...
El ENCARGADO tratará los datos personales **únicamente siguiendo las instrucciones documentadas del RESPONSABLE**, y exclusivamente para la finalidad indicada en la cláusula primera. No los empleará para finalidad propia alguna ni los aplicará o utilizará con fin distinto.

Si el ENCARGADO considera que alguna instrucción infringe la normativa de protección de datos, informará de inmediato al RESPONSABLE.

Si el ENCARGADO determinase por su cuenta las finalidades o los medios del tratamiento, será considerado responsable del tratamiento respecto de esas operaciones y asumirá las consecuencias.
...
3. Categorías y número aproximado de interesados y de registros afectados.
4. Datos de contacto de la persona responsable de la información.
5. Descripción de las posibles consecuencias.
6. Medidas adoptadas o propuestas para poner remedio y mitigar los efectos.

El ENCARGADO **no notificará la brecha a la autoridad de control ni a los interesados** por su cuenta: la decisión y la notificación corresponden al RESPONSABLE.
...
El ENCARGADO llevará el registro de las categorías de actividades de tratamiento efectuadas por cuenta del RESPONSABLE, con el contenido exigido por la normativa aplicable, y lo pondrá a su disposición a requerimiento.
...
> **Advertencias:**  
> 1. Este documento es un DRAFT. Debe ser revisado por el profesional responsable o por el delegado de protección de datos antes de su firma.  
> 2. **Verificar el contenido mínimo vigente del artículo 28 del Reglamento (UE) 2016/679** y comprobar que el contrato lo cumple íntegramente. La omisión de cualquiera de sus elementos es un defecto que la autoridad de control detecta con facilidad.  
> 3. **Comprobar la dirección del contrato:** si el despacho contrata a un proveedor que accederá a datos, el despacho es responsable y el proveedor encargado; si el despacho presta el servicio por cuenta de un cliente, es el despacho quien actúa como encargado. Determinar mal el rol invalida el documento entero.  
> 4. **Contratos con todos los proveedores que accedan a datos**, incluidos los que no se perciben como tales: servicio de correo electrónico, almacenamiento en la nube, asesoría, informática, gestión documental, destrucción de papel, mensajería y transcripción.  
> 5. **Transferencias internacionales:** si el tratamiento se ubica fuera del Espacio Económico Europeo, identificar el destino y la garantía aplicable, y verificar el régimen y las garantías vigentes antes de consignarlas.  
> 6. **Subcontratación:** decidir expresamente si se autoriza, con qué régimen de información y de oposición, y con la obligación del encargado de imponer al subencargado las mismas obligaciones.  
> 7. **Secreto profesional:** cuando el encargado accede a información de asuntos, el deber de confidencialidad debe reforzarse expresamente por su interacción con el secreto profesional del despacho, cuyo incumplimiento tiene consecuencias deontológicas propias.  
> 8. **Plazos de notificación de brechas:** el plazo del encargado hacia el responsable debe ser sensiblemente **inferior** al que el responsable tiene frente a la autoridad de control; de lo contrario, el responsable no llega a tiempo.  
> 9. **Auditoría:** un derecho de auditoría sin periodicidad ni procedimiento es papel mojado. Concretarlo.  
> 10. **Acreditación de la supresión** a la terminación: exigir constancia documental, no una simple manifestación verbal.

...
- **REG-CLI-03: Detección de nuevos clientes y guardado consentido mediante formulario (`save_client` & `restricted_human_in_the_loop_request`):**
  ...
  1. **Consulta obligatoria mediante formulario:** El asistente DEBE preguntar inmediatamente al usuario mediante un formulario de opciones cerradas (`restricted_human_in_the_loop_request`) si desea guardar a la persona como nuevo cliente en la plataforma.

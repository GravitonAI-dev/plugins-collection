...
> Version de la LAU verificada en el BOE: 25/05/2023 (Ley 12/2023)

---

En {{municipio}}, a 21/08/2026
...
La vivienda arrendada se destinara exclusivamente a satisfacer la necesidad permanente de vivienda habitual del ARRENDATARIO <!-- y de las siguientes personas: {{personas_convivientes}} -->, de conformidad con lo dispuesto en el articulo 2 de la LAU.
...
La parte que desee aplicar la actualizacion notificara a la otra por escrito el porcentaje de variacion aplicado.

### SEXTA — Fianza

En este acto, el ARRENDATARIO hace entrega al ARRENDADOR de la cantidad de {{importe_fianza}} euros ({{importe_fianza_letras}} euros), equivalente a 1 mensualidad de renta, en concepto de fianza legal obligatoria, de conformidad con el articulo 36.1 de la LAU.
...
<!-- Si se pactan garantias adicionales: GARANTIA ADICIONAL: las partes acuerdan ademas {{tipo de garantia adicional: aval bancario / seguro de impago / deposito adicional}} por importe de {{importe_garantia_adicional}} euros. -->
...
> 2. Version de la LAU verificada: 25/05/2023 (Ley 12/2023).
